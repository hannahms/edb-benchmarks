...
```shell
$ git clone git@github.com:<user>/edb-benchmarks.git
```
  3. Go to repository folder
  4. Add main repository as an upstream repository:
```shell
$ git remote add upstream https://github.com/EnterpriseDB/edb-benchmarks.git
```
...
```
  5. Create the Pull Request by opening the web link:
     `https://github.com/<user>/edb-benchmarks/pull/new/new_feature`
