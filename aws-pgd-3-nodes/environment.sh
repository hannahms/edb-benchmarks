...
export DBT2_CONNECTIONS_MIN="${DBT2_CONNECTIONS_MIN:=5}"
export DBT2_CONNECTIONS_MAX="${DBT2_CONNECTIONS_MAX:=100}"
export DBT2_CONNECTIONS_STEP="${DBT2_CONNECTIONS_STEP:=5}"
export DBT2_RAMPUP="${DBT2_RAMPUP:=1}"
